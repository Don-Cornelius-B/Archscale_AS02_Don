...
import { Play, MessageSquare, Mail, StickyNote, Zap } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {presets.map((preset) => (
            <button
              ...
              className="text-left p-3 rounded-lg border border-zinc-800 bg-zinc-900 hover:bg-zinc-800/80 hover:border-zinc-700 transition-colors disabled:opacity-50"
            >
